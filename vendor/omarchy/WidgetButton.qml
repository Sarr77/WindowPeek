// Adapted from Omarchy 4.0.4 shell/Ui/WidgetButton.qml (MIT). See LICENSE here.
// WindowPeek: allow ink and glyph shadow to switch together without a color tween.
import QtQuick
import qs.Commons
...
Item {
  ...
  property bool animateTextColor: true
  ...
  Text {
    ...
    Behavior on color {
      enabled: root.animateTextColor && (!root.bar || root.bar.foregroundAnimationEnabled)
