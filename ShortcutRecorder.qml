        ...
        Flickable {
            ...
            Column {
                ...
                Text {
                    ...
                    color: root.accent; font.bold: true; font.pixelSize: Style.font.subtitle
                ...
                Rectangle {
                    ...
                    Text {
                        ...
                        color: Color.popups.text; font.pixelSize: Style.font.subtitle; font.bold:true
                    }
                }
                LabelButton {
                ...
                Text {
                    ...
                    textFormat: Text.PlainText; wrapMode: Text.Wrap; color: Qt.alpha(Color.popups.text,0.75); font.pixelSize:Style.font.caption
                }
                Row {
                ...
                Row {
                    ...
                    Ui.Button { width:(body.width-parent.spacing)/2; text:root.words.cancel; focusable:true; onClicked:root.close() }
                    Ui.Button {
